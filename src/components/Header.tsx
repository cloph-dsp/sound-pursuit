  ...
  return (
    <div className="container text-center mx-auto mt-8 mb-4 px-4 sm:mt-12 sm:mb-6 sm:text-2xl">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 mb-2">
        ...
        <h1 className="text-responsive font-bold bg-gradient-to-r from-blue-500 to-blue-700 dark:from-blue-400 dark:to-blue-600 bg-clip-text text-transparent animate-wave text-3xl sm:text-4xl">
          Sound Pursuit
        </h1>
      </div>
      <p className="text-blue-600/80 dark:text-blue-400/80 text-sm sm:text-base font-light break-words whitespace-normal leading-relaxed">
